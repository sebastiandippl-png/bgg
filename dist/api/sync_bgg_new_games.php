...
try {
    ...
    write_bgg_sync_status([
        ...
        'message' => 'New games sync complete. Inserted ' . $result['insertedGames'] . ' new games, updated ownership for ' . $result['updatedOwnedGames'] . ' games, and removed ' . $result['removedGames'] . ' games no longer in collection.',
        'username' => get_bgg_sync_username(),
        'fetchedGames' => $result['fetchedGames'],
        'newGames' => $result['newGames'],
        'insertedGames' => $result['insertedGames'],
        'updatedOwnedGames' => $result['updatedOwnedGames'],
